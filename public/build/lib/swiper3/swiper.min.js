    ...
    var e, a = function(s, i) {
        ...
        if (T.params = i,
            ...
            T.container[0].swiper = T,
                ...
                T.params.touchReleaseOnEdges && (T.params.resistanceRatio = 0), ["cube", "coverflow", "flip"].indexOf(T.params.effect) >= 0 && (T.support.transforms3d ? (T.params.watchSlidesProgress = !0,
            ...
            T.onTouchStart = function(a) {
                                ...
                                if (A) {
                                    T.allowClick = !1,
                                        ...
                                        C || (i.loop && T.fixLoop(),
                                            ...
                                            D = !1, !T.params.grabCursor || T.params.allowSwipeToNext !== !0 && T.params.allowSwipeToPrev !== !0 || T.setGrabCursor(!0)),
                                        C = !0;
                                    ...
                                    if (s > 0 && P > T.minTranslate() ? (r = !1,
                                        ...
                                        r && (a.preventedByNestedSwiper = !0), !T.params.allowSwipeToNext && "next" === T.swipeDirection && P < I && (P = I), !T.params.allowSwipeToPrev && "prev" === T.swipeDirection && P > I && (P = I),
                ...
                T.disableMousewheelControl = function() {
                    ...
                    return "container" !== T.params.mousewheelEventsTarged && (a = e(T.params.mousewheelEventsTarged)),
                        ...
                        T.params.mousewheelControl = !1, !0
                },
                T.enableMousewheelControl = function() {
                    ...
                    return "container" !== T.params.mousewheelEventsTarged && (a = e(T.params.mousewheelEventsTarged)),
                        ...
                        T.params.mousewheelControl = !0, !0
                },
                T.parallax = {
                    setTranslate: function() {
                        ...
                        if (a.gesture.image && 0 !== a.gesture.image.length && (T.allowClick = !1,
                            ...
                            if (!(t < a.gesture.slideWidth && s < a.gesture.slideHeight)) {
                                if (a.image.minX = Math.min(a.gesture.slideWidth / 2 - t / 2, 0),
                                    ...
                                    a.image.touchesCurrent.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, !a.image.isMoved && !a.isScaling) {
